...
if(lengthVal.length%2!=0)lengthVal="0"+lengthVal;if(parseInt(lengthVal,16)>128){len="8"+(lengthVal.length/2).toString(16);len+=lengthVal}else len=lengthVal;tmp.len=len;return tmp}};